    ...
    <>
       <Pagenav/>
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Shri_Pathar_Sahib.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Shri_Pathar_Sahib
