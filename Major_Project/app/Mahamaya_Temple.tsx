  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Mahamaya_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :5:00 AMto 9:00PM.</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Mahamaya Temple
                Mahamaya Hill, Hazaribagh, Jharkhand, India</Text>
...
export default Mahamaya_Temple
