  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Vaishno_Devi_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Vaishno_Devi_Temple
