...
const Bannerghatta_Biological_Park = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Bannerghatta_Biological_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Bannerghatta Biological Park,
Bannerghatta Road,
Bengaluru, Karnataka 560083, India.</Text>
...
export default Bannerghatta_Biological_Park
