...
const Lalbagh_Botanical_Garden = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=12.949416,77.58468`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Lalbagh_Botanical_Garden.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Lalbagh Botanical Garden,
Mavalli,
Bangalore, Karnataka, India
Postal Code: 560004</Text>
...
export default Lalbagh_Botanical_Garden
