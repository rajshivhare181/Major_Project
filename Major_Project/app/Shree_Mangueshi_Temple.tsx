...
const Shree_Mangueshi_Temple = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=15.444905,73.966383`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Shree_Mangueshi_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Shree Mangueshi Temple
Priol,
Ponda, South Goa,
Goa,
India - 403401.</Text>
...
export default Shree_Mangueshi_Temple
