...
const ISKCON_Temple_Bangalore = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=13.009664,77.551134`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/ISKCON_Temple_Bangalore.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing : 4 AM- 1 PM</Text>
                { 4 <= hour && 12 >= hour ? 
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :ISKCON Bangalore,
...
export default ISKCON_Temple_Bangalore
