  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const imageAnimatedStyle = useAnimatedStyle(() => {
       ...
       const openGoogleMaps = () => {
              const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=34.215692,75.50412`;
    ...
    <>
     <Pagenav/>
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Amarnath_Cave_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Amarnath Cave, Pahalgam, Anantnag District, Jammu & Kashmir, 192301, India.</Text>
...
export default Amarnath_Cave_Temple
