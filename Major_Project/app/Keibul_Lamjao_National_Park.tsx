...
const Keibul_Lamjao_National_Park = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
        const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=24.4752,93.8496`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Keibul_Lamjao_National_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Keibul_Lamjao_National_Park
