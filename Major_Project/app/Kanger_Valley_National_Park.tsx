...
const Kanger_Valley_National_Park = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Kanger_Valley_National_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Kanger Valley National Park,
Bastar District,
Chhattisgarh, India
...
export default Kanger_Valley_National_Park
