  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Hirwavan_Garden.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Hirwavan_Garden Garden,
Near Jampore Beach,
Daman,</Text>
...
export default Hirwavan_Garden
