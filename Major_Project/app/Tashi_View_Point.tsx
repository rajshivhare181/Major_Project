  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Tashi_View_Point.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing : 4:00 AM to 6:00 PM</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Tashi View Point,
Gangtok, East Sikkim,
Sikkim, India</Text>
...
export default Tashi_View_Point
