  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Namdapha_National_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Namdapha National Park
Changlang District,
Arunachal Pradesh,
India
Pincode: 792120</Text>
...
export default Namdapha_National_Park
