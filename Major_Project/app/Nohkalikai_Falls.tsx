  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Nohkalikai_Falls.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Nohkalikai_Falls
