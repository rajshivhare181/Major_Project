...
const Immaculate_Conception_Church = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Immaculate_Conception_Church.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Church Square,
Panaji,
North Goa,
Goa,
India - 403001.</Text>
...
export default Immaculate_Conception_Church
