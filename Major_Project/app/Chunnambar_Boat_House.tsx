...
const Chunnambar_Boat_House = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=11.883813,79.800688`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Chunnambar_Boat_House.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.ticket}>
                <Text style={styles.text}>Ticket : ₹100 - ₹200 for adults</Text>
                <TouchableOpacity activeOpacity={0.7} style = {styles.book}>
                    <Text style={styles.text}>Book</Text>
                </TouchableOpacity>
            </View>
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Chunnambar Boat House, Chunnambar River, Pondicherry 605002, India</Text>
...
export default Chunnambar_Boat_House
