...
Sai Baba spent much of his life in Shirdi, where he attracted a large following. He performed many miracles and was known for his deep connection to the divine, often advising people to have faith and patience.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Shirdi_Sai_Mandir.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Shirdi Sai Mandir,
Shirdi,
Ahmednagar District,
Maharashtra 423109,
India.</Text>
...
export default  Shirdi_Sai_Mandir
