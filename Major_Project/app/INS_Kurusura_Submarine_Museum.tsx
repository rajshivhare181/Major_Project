...
const INS_Kurusura_Submarine_Museum = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `INS Kurusura was a Foxtrot-class submarine that was commissioned into the Indian Navy on December 18, 1969. It was originally built in the Soviet Union (now Russia) in 1963 and served the Indian Navy for over three decades.
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/INS_Kurusura_Submarine_Museum.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.ticket}>
                <Text style={styles.text}>Ticket : RS 200 for adults .
               </Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :INS Kurusura Submarine Museum
Ramakrishna Beach,
Visakhapatnam,
Andhra Pradesh,
India
...
export default INS_Kurusura_Submarine_Museum
