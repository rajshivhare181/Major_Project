  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Le_Corbusier_Centre.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing : 10:00 AM - 6:00 PM</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Le Corbusier Centre, Sector 19-B, Chandigarh, India
                Pincode: 160019</Text>
...
export default Le_Corbusier_Centre
