...
const Itanagar = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=27.084368,93.605316`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Itanagar.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Itanagar
Papum Pare District,
Arunachal Pradesh,
India
Pincode: 791111
