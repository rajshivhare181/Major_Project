...
const Gurudwara_Panja_Sahib = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=33.820827,72.689811`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Gurudwara_Panja_Sahib.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Gurudwara Panja Sahib, Hassan Abdal, Punjab, Pakistan
</Text>
...
export default Gurudwara_Panja_Sahib
