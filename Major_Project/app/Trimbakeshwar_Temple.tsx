...
It is believed that the temple was built in the 18th century by Shreemant Madhavrao I of the Peshwa dynasty, although the site itself has ancient origins linked to the Kritayuga period.
The Trimbakeshwar Temple is closely associated with the origin of the Godavari River, which flows from the Godavari Kund located near the temple. The river is considered sacred, and taking a dip in its waters is believed to cleanse one’s sins.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Trimbakeshwar_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Trimbakeshwar Temple,
Trimbak,
Nashik,
Maharashtra 422212,
India.</Text>
...
export default Trimbakeshwar_Temple
