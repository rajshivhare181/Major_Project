...
const Lingaraj_Temple = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=20.235194,85.833989`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Lingaraj_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Lingaraj Temple,
Bhubaneswar,
Odisha 751002,
India</Text>
...
export default Lingaraj_Temple
