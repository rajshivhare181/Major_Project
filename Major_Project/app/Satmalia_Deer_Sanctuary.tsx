  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Satmalia_Deer_Sanctuary.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Satmalia Deer Sanctuary,
...
export default Satmalia_Deer_Sanctuary
