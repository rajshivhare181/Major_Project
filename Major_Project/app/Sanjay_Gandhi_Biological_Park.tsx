...
const Sanjay_Gandhi_Biological_Park= () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Sanjay_Gandhi_Biological_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :9:00 AM - 5:00 PM.</Text>
...
export default Sanjay_Gandhi_Biological_Park
