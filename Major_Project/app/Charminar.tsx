...
const Charminar = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History : Charminar, an iconic monument in Hyderabad, Telangana, was built in 1591 by Sultan Muhammad Quli Qutb Shah, the founder of Hyderabad. The structure commemorates the end of a deadly plague that ravaged the city. Its name, meaning "Four Towers," refers to its four grand minarets, each standing at 48.7 meters. Charminar is a fine example of Indo-Islamic architecture, with intricate carvings and arches. It also served as a mosque and a prominent trade hub. Surrounding the monument is the bustling Laad Bazaar, famous for bangles and textiles. Today, Charminar symbolizes Hyderabad’s rich cultural and historical heritage.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Charminar.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Charminar, Ghansi Bazaar, Hyderabad, Telangana, India
                Pin Code: 500002</Text>
