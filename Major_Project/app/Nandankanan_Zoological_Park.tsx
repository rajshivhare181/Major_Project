...
const Nandankanan_Zoological_Park = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Nandankanan_Zoological_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Nandankanan Zoological Park,
Nandankanan,
Bhubaneswar,
Odisha 751002,
India</Text>
...
export default Nandankanan_Zoological_Park
