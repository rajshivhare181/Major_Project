...
const French_Quarter = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `The French Quarter in Puducherry was established during the period of French colonial rule, which lasted from 1674 until 1954. The area, also known as White Town, is where the French settlers lived and worked.
The French influence is still evident in the streets, architecture, and even the lifestyle of the area. Many of the buildings in the French Quarter were designed in the French colonial style, with yellow and white facades, colonial-era windows, and elegant doorways.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/French_Quarter.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :White Town (French Quarter), Puducherry.
</Text>
