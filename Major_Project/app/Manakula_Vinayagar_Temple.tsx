...
const Manakula_Vinayagar_Temple = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :The Manakula Vinayagar Temple is believed to have been built more than 400 years ago and is one of the oldest temples in Puducherry. It holds significant religious and cultural importance in the region.
The temple is dedicated to Lord Vinayagar (Ganesha), and it is believed that worshiping here removes obstacles from one’s life and brings prosperity and good fortune.
According to local legends, the temple was originally a simple structure built by local fishermen and traders, later expanded with contributions from various rulers over time.`;
    ...
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Manakula Vinayagar Temple Road,
