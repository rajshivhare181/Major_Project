...
const Barnawapara_Wildlife_Sanctuary = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Barnawapara_Wildlife_Sanctuary.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Barnawapara Wildlife Sanctuary,
Mahasamund District,
...
export default Barnawapara_Wildlife_Sanctuary
