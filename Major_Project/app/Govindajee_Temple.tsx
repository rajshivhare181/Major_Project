  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Govindajee_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Govindajee_Temple
