  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Anthurium_Waterfall.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default  Anthurium_Waterfall
