  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Gurudongmar_Lake.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Gurudongmar Lake,
North Sikkim,
Sikkim, India.
</Text>
...
export default Gurudongmar_Lake
