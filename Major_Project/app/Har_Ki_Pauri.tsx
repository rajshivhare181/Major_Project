...
const Har_Ki_Pauri  = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :Har Ki Pauri, located in Haridwar, Uttarakhand, is one of the most sacred ghats on the banks of the Ganges River. The name means "Steps to Lord Shiva," and it is believed that Lord Vishnu's footprint is imprinted on a stone here. Built by King Vikramaditya in the 1st century BCE to honor his brother Bharthari, this ghat is a major site for religious ceremonies and festivals. It is especially famous for the Ganga Aarti, a mesmerizing ritual held every evening. Har Ki Pauri is a focal point for pilgrims during the Kumbh Mela and is a must-visit for spiritual seekers.`;
    ...
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Har Ki Pauri, Haridwar, Uttarakhand, 249401, India.</Text>
