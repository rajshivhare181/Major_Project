  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Konark_Sun_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Konark_Sun_Temple
