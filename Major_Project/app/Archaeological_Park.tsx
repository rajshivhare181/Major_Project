...
const Archaeological_Park= () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=22.485829,73.537245`;
    ...
    <>
       <Pagenav/>
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Archaeological_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Archaeological Site
Dholavira,
Khadir Island,
Kutch District,
Gujarat,
...
export default Archaeological_Park
