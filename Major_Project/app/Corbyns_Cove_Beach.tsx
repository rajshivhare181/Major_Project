  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Corbyns_Cove_Beach.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Corbyns_Cove_Beach
