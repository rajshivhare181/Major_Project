  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Monuments_at_Hampi.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
Hospet Taluk,
Ballari District, Karnataka 583239, India</Text>
...
export default Monuments_at_Hampi
