  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/UB_City.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :10:00 AM - 9:00 PM</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : UB City,
Vittal Mallya Road,
Kumara Park West,
