...
const Zakir_Hussain_Rose_Garden = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Zakir_Hussain_Rose_Garden.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :5:00 AM - 10:00 PM</Text>
...
export default Zakir_Hussain_Rose_Garden
