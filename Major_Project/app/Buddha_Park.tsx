  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Buddha_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
    ...
    <Text style={styles.time1}>Close</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Buddha Park,
