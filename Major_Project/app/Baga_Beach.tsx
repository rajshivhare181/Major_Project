  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Baga_Beach.png')} style={[styles.photo, imageAnimatedStyle]}/>
    ...
    <Text style={styles.time1}>Close</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Baga Beach
Baga,
North Goa,
Goa,
India - 403516.</Text>
