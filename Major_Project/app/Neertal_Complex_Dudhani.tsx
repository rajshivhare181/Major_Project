  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Neertal_Complex_Dudhani.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Neertal Tourist Complex,
Dudhani Village,
Mungeli District,
...
export default Neertal_Complex_Dudhani
