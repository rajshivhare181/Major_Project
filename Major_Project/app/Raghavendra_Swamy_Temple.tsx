...
const Raghavendra_Swamy_Temple = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Raghavendra_Swamy_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :5:00 AM to 5:00 PM</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Radhanagar Beach
...
export default Raghavendra_Swamy_Temple
