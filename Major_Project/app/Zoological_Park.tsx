...
const Zoological_Park = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `Established in 1876, the Alipore Zoological Gardens is one of the oldest zoological parks in India. Located in the heart of Kolkata, it houses a wide variety of animals, including Royal Bengal tigers, white tigers, bears, elephants, and various species of birds and reptiles. The zoo also has a well-maintained aquarium and is involved in conservation efforts for endangered species. The zoo remains a popular family destination for residents and tourists alike, offering educational programs and opportunities to see wildlife up close in a historical setting.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Zoological_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Alipore Zoo, Kolkata, West Bengal, 700027, India.</Text>
...
export default Zoological_Park
