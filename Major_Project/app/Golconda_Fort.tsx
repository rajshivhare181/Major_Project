...
const Golconda_Fort = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :Golconda Fort, located in Hyderabad, Telangana, is a majestic fortress with a history dating back to the 12th century, built by the Kakatiya dynasty. Later, it was expanded by the Qutb Shahi dynasty in the 16th century, serving as their capital. Renowned for its architectural brilliance, it features advanced water supply systems, acoustics, and sprawling fortifications. Golconda was once a flourishing diamond trade center, producing legendary gems like the Koh-i-Noor and Hope Diamond. The fort, with its massive gateways, bastions, and mosques, symbolizes Hyderabad's rich heritage. Despite its decline after Aurangzeb's siege in 1687, it remains a significant historical landmark.`;
    ...
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing :9 AM and 5 PM</Text>
                { 9 <= hour && 16 >= hour ? 
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Golconda Fort, Khair Complex, Ibrahim Bagh, Hyderabad, Telangana, India
                Pin Code: 500008
</Text>
