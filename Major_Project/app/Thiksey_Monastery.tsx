...
const Thiksey_Monastery = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const openGoogleMaps = () => {
      const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=34.055914,34.055914`;
       ...
       <Pagenav/>
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Thiksey, Leh, Ladakh, Jammu & Kashmir, India.
</Text>
