  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Yadavindra_Gardens.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Yadavindra Gardens
Pinjore,
District Panchkula,
Haryana,
India - 134102.</Text>
...
export default Yadavindra_Gardens
