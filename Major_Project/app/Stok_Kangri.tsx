  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Stok_Kangri.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.ticket}>
                <Text style={styles.text}>Ticket :₹30000 - ₹50000 for adult
               </Text>
