...
const Kailasanathar_Temple = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :The Kailasanathar Temple is one of the oldest and most important Hindu temples dedicated to Lord Shiva. Located in Mylapore, Chennai, Tamil Nadu, the temple dates back to the 7th century CE and was constructed during the reign of the Pallava dynasty. It is a prime example of Pallava architecture and is renowned for its stunning Dravidian style of temple architecture.
    The temple is dedicated to Lord Shiva in his form as Kailasanathar (Lord of Mount Kailash), with a prominent shrine for Goddess Parvati as well.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Kailasanathar_Temple.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Kailasanathar Temple, Mylapore, Chennai, Tamil Nadu, India.</Text>
...
export default Kailasanathar_Temple
