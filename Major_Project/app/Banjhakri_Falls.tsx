  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Banjhakri_Falls.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Banjhakri Falls,
Ranka Road,
Gangtok, East Sikkim,
Sikkim, India.</Text>
...
export default Banjhakri_Falls
