...
const Jaldapara_National_Park = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :Jaldapara National Park, located in the Alipurduar district of West Bengal, was established in 1941 as a wildlife sanctuary and later upgraded to a national park in 2012. The park is situated in the Dooars region, near the foothills of the Himalayas, and is famous for its Indian one-horned rhinoceros population. The park is also home to a wide variety of animals, including tigers, elephants, bison, and leopards, along with numerous species of birds. It is an important part of India’s conservation efforts and attracts nature lovers and wildlife enthusiasts from around the world.
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Jaldapara_National_Park.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Jaldapara National Park, Alipurduar, West Bengal, 736121, India.
</Text>
...
export default Jaldapara_National_Park
