...
const Ramoji_Film_City = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :Ramoji Film City, located in Hyderabad, Telangana, is the world's largest integrated film studio complex, established in 1991 by filmmaker and entrepreneur Ramoji Rao. Spanning over 2,000 acres, it serves as a one-stop destination for filmmaking, offering state-of-the-art infrastructure and versatile sets. Over the years, it has hosted numerous Indian and international film productions. Beyond its role in cinema, it is a major tourist attraction with themed parks, adventure zones, and live entertainment. Recognized by the Guinness World Records, Ramoji Film City is a blend of cinematic magic, cultural richness, and family-friendly attractions, drawing millions of visitors annually.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Ramoji_Film_City.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.ticket}>
                <Text style={styles.text}>Ticket :₹1,350 for adult    
               </Text>
...
export default Ramoji_Film_City
