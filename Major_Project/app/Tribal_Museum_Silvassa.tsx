  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Tribal_Museum_Silvassa.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address : Tribal Museum, Silvassa
Near Satyam Shivam Sundaram Temple,
...
export default Tribal_Museum_Silvassa
