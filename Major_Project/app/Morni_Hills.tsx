...
const Morni_Hills = () => {
  ...
  const [showFullText, setShowFullText] = useState(false);
    ...
    const fullHistoryText = `History :Morni Hills, located in the Panchkula district of Haryana, is the only hill station in the state. The area is steeped in history and natural beauty, with its name derived from the local folklore. "Morni" refers to a peacock, which is also the symbol of the region. Historically, it was believed to be a royal retreat for the kings of Haryana and Punjab. The hills are dotted with forts, temples, and beautiful lakes, making it a popular destination for trekkers, nature enthusiasts, and those seeking peace and tranquility in the lap of nature.`;
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Morni_Hills.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Morni Hills, Panchkula, Haryana, India.</Text>
