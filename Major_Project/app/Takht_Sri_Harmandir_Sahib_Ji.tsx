...
const Takht_Sri_Harmandir_Sahib_Ji = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Takht_Sri_Harmandir_Sahib_Ji.png')} style={[styles.photo, imageAnimatedStyle]}/>
...
export default Takht_Sri_Harmandir_Sahib_Ji
