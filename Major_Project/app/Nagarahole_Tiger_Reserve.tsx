...
const Nagarahole_Tiger_Reserve = () => {
  ...
  return (
    <>
        ...
        <Animated.ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
            <Animated.Image source={require('@/assets/images/Nagarahole_Tiger_Reserve.png')} style={[styles.photo, imageAnimatedStyle]}/>
            ...
            <View style={styles.timing}>
                <Text style={styles.text}>Timing : 6:00 AM - 6:00PM</Text>
            ...
            <View style={styles.address}>
                <Text style={styles.text_address}>Address :Nagarahole Tiger Reserve,
Kabini, Heggadde,
...
export default Nagarahole_Tiger_Reserve
